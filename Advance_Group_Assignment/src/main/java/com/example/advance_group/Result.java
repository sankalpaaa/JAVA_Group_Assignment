...
public class Result {
    ...
    private void readResultFromFile() {
        try (BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\ACER\\Desktop\\Advance_Group_Assignment-master\\src\\main\\java\\com\\example\\advance_group\\result\\result.txt"))) {
            String line;
                ...
                if (data.length == 6) {
                    ...
                    if (questionId == loggedInUserId) {
                        ...
                        if(Objects.equals(verdict, "pass")){
                            displayCitizen.setText("Congratulations");
                        }else {
                            displayCitizen.setText("Congratulations");
                        }
                    }
