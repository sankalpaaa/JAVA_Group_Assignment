...
public class Quizpagecontroller {
    ...
    void loadNextQuestion(ActionEvent event) {
        if (currentQuestionIndex < questionsList.size() - 1) {
            ...
            checkAndDisableOptionButtons(currentQuestionIndex);
            answerSelected = false;
        } else if (currentQuestionIndex == questionsList.size() - 1) {
            // Handle the last question separately if needed
            displayCurrentQuestion();
            checkAndDisableOptionButtons(currentQuestionIndex);
            answerSelected = false;
        }
    ...
    private void updateQuestionsAttemptedMessage() {
        int totalQuestions = 15;  // Updated to 15 questions
    ...
    public void getquestion() throws FileNotFoundException {
        ...
        if (nationality.equals("Nepal")) {
            String imagePath = "C:\\Users\\ACER\\Desktop\\Advance_Group_Assignment-master\\src\\main\\resources\\com\\example\\advance_group\\countryflag\\nepal.png";
            Image image = new Image(new FileInputStream(imagePath));
            //getflag.setImage(image);
            selectedFile = new File("C:\\Users\\ACER\\Desktop\\Advance_Group_Assignment-master\\src\\main\\java\\com\\example\\advance_group\\questions\\MCQ.txt");
        } else if (nationality.equals("India")) {
            String imagePath = "C:\\Users\\ACER\\Desktop\\Advance_Group_Assignment-master\\src\\main\\resources\\com\\example\\advance_group\\countryflag\\india.png";
            Image image = new Image(new FileInputStream(imagePath));
            //getflag.setImage(image);
            selectedFile = new File("C:\\Users\\ACER\\Desktop\\Advance_Group_Assignment-master\\src\\main\\java\\com\\example\\advance_group\\questions\\MCQ.txt");
        } else if (nationality.equals("China")) {
            String imagePath = "C:\\Users\\ACER\\Desktop\\Advance_Group_Assignment-master\\src\\main\\resources\\com\\example\\advance_group\\countryflag\\china.png";
            Image image = new Image(new FileInputStream(imagePath));
            //getflag.setImage(image);
            selectedFile = new File("C:\\Users\\ACER\\Desktop\\Advance_Group_Assignment-master\\src\\main\\java\\com\\example\\advance_group\\questions\\MCQ.txt");
        }
    ...
    void submitButtonClicked(ActionEvent event) {
        if (clickedQuestionsList.size() == 15) {  // Updated to 15 questions
            printCorrectAnswers();
            printWrongAnswers();
            stopTimer();
            System.out.println("Current Logged In User ID: " + loggedInUserId);
            writeResultsToFile("C:\\Users\\ACER\\Desktop\\Advance_Group_Assignment-master\\src\\main\\java\\com\\example\\advance_group\\result\\result.txt", loggedInUserId);
            gotoresultpage();
        } else {
            int totalQuestions = 15;  // Updated to 15 questions
            int questionsAttempted = clickedQuestionsList.size();
